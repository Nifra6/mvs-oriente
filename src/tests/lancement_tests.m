			...
			for i_rayon_voisinage = 1:nb_rayon_voisinage
				...
				for i_nombre_profondeur = 1:nb_nombre_profondeur
					...
					for i = 1:nombre_iteration
						...
						% Exécution
						disp("MVS :");
						[z_estime_mvs,erreur_z_mvs,angles_mvs,normales_mvs] = mvs(premiere_iteration,surface,nombre_vues,rayon_voisinage,ecart_type,nombre_z,z_estime_mvs,espace_z);
						disp("MVS modifié :");
