...
%% Paramètres
valeur_bruitage = 6;
liste_surface = ["gaussienneDecentree_bruite" + int2str(valeur_bruitage), "sinusCardinal_bruite" ...
	+ int2str(valeur_bruitage), "calotteSphere_bruite" + int2str(valeur_bruitage)];
nombre_vues = 5;
rayon_voisinage = 4;
nombre_iteration = 1;
