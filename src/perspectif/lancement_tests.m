...
%liste_surface = ["boite"];
%liste_surface = ["planReel"];
%liste_surface = ["calotteSphere","gaussienneDecentree","gaussienneAnisotrope","sinusCardinal"];
%liste_surface = ["calotteSphere_planche16","gaussienneDecentree_planche16","gaussienneAnisotrope_planche16","sinusCardinal_planche16"];
liste_surface = ["calotteSphere_bruite" + int2str(valeur_bruitage),"gaussienneDecentree_bruite" + int2str(valeur_bruitage),"gaussienneAnisotrope_bruite" + int2str(valeur_bruitage),"sinusCardinal_bruite" + int2str(valeur_bruitage)];
%liste_surface = ["calotteSphere_planche16_bruite" + int2str(valeur_bruitage),"gaussienneDecentree_planche16_bruite" + int2str(valeur_bruitage),"gaussienneAnisotrope_planche16_bruite" + int2str(valeur_bruitage),"sinusCardinal_planche16_bruite" + int2str(valeur_bruitage)];
