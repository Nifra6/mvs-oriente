...
while 1
	...
	figure(f2);
	imagesc(reshape(I_1_voisinage,taille_voisi,taille_voisi));
	title("Image 1");

	figure(f3);
	imagesc(reshape(I_k_voisinage,taille_voisi,taille_voisi));
	title("Image k");

	figure(f4);
	imagesc(reshape(I_1_voisinage-I_k_voisinage,taille_voisi,taille_voisi));
	title("Différence entre 2 images");
	colorbar;


	reshape(I_1_voisinage-I_k_voisinage,taille_voisi,taille_voisi)
