...
R_2_part_2 = [cos(angle_k(2)) , -sin(angle_k(2)) , 0;...
	   		  sin(angle_k(2)) , cos(angle_k(2))  , 0;...
	   		  0               , 0                , 1];
R_2 = R_2_part_1 * R_2_part_2;
t_cam = t_cam;
% Fin WIP
...
for i_2 = 1:taille
	for j_2 = 1:taille
		deplacement = t_cam - R_2 * t_cam;
		x_2 = X(i_2,j_2) + deplacement(1);
		y_2 = Y(i_2,j_2) + deplacement(2);
		rho_carre_2 = (x_2)^2+(y_2)^2;
		if rho_carre_2 <= rayon_sphere^2
			z_2 = sqrt(rayon_sphere^2-rho_carre_2);
			P_2 = [ x_2 ; y_2 ; z_2 ];
			P_1 = R_2 * P_2;
			%P_1 = R_2 * (P_2 - (t_cam - R_2' * t_cam));
			%P_1 = R_2 * P_2 - (t_cam - R_2' * t_cam);
...
for i_3 = 1:taille
	for j_3 = 1:taille
		deplacement = t_cam - R_3 * t_cam;
		x_3 = X(i_3,j_3) + deplacement(1);
		y_3 = Y(i_3,j_3) + deplacement(2);
