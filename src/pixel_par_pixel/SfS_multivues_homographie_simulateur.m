...
%% Paramètres
valeurs_z 		= 4:0.05:5;	% Les valeurs de profondeurs utilisées
rayon_voisinage	= 100;			% Voisinage à prendre en compte
...
masque_1(:,1:rayon_voisinage) = 0;
masque_1(:,end-rayon_voisinage:end) = 0;
masque_2(1:rayon_voisinage,:) = 0;
masque_2(end-rayon_voisinage:end,:) = 0;
masque_2(:,1:rayon_voisinage) = 0;
masque_2(:,end-rayon_voisinage:end) = 0;
rayon_voisinage = 1;
...
liste_normales = zeros(nombre_lignes, nombre_colonnes, 3);
...
[A, indices_min] = min(scores_corriges, [], 2);
