...
rayon_voisinage = 4;			% Rayon du voisinage carré à prendre en compte
...
for indice_z = 1:nombre_z
	...
	score_ZNCC_k = zeros(nombre_pixels_etudies, nombre_images-1);
	for k = 1:nombre_images-1
		...
		erreur_ZNCC_k(:,k) = 1 - ZNCC(I_1_voisinage,I_k_voisinage);
	end
