...
load ../../data/orthographique/simulateur.mat;
...
save('../../data/orthographique/simulateur_formate.mat','nb_images', 'nb_lignes', 'nb_colonnes', 'indice_image_reference', 's', 'K', 'u_0', 'v_0', 'f', 'facteur_k', 'I', 'masque', 'R', 't', 'z', 'N');
